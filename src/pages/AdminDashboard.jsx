...
import { FaCheck, FaTimes, FaReply, FaUserTie, FaUsers, FaExchangeAlt, FaBell } from 'react-icons/fa';
...
const AdminDashboard = () => {
  ...
  // Fetch all admin requests and calculate stats
  useEffect(() => {
  ...
  const handleStatusUpdate = async (requestId, newStatus) => {
    try {
      ...
      setStats(prevStats => ({
        ...prevStats,
        pendingRequests: newStatus === 'pending' ? prevStats.pendingRequests + 1 : prevStats.pendingRequests - 1,
        approvedRequests: newStatus === 'approved' ? prevStats.approvedRequests + 1 : prevStats.approvedRequests - 1,
        rejectedRequests: newStatus === 'rejected' ? prevStats.rejectedRequests + 1 : prevStats.rejectedRequests - 1
      }));
    } catch (err) {
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex items-center">
            <FaUserTie className="text-indigo-600 text-2xl mr-2" />
            <div>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex items-center">
            <FaBell className="text-yellow-600 text-2xl mr-2" />
            <div>
        ...
        <div className="bg-white p-4 rounded-lg shadow">
          <div className="flex items-center">
            <FaTimes className="text-red-600 text-2xl mr-2" />
            <div>
